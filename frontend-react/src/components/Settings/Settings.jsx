  ...
  return (
    <div className="container">
      ...
      <div className="Settings-box">
        ...
        <div className="first-line">
          <div>
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSef6SpQHkxHhOljG--3qFgDOXYPdd1wkrFxsRYDxfT9LcDgsw/viewform" target="_blank"><button className="btn"> RATING</button></a>
          </div>
